...
paneeliteksti <- function() wellPanel(
               ...
               tags$a("Paavo-data Tilastokeskuksen rajapintapalvelusta 23.4.2019 lisenssillä CC BY 4.0",
                      href="https://tilastokeskus.fi/tup/rajapintapalvelut/paavo.html"))

shinyUI(
  #Koetekstiä tähän#,
    navbarPage("Eduskuntavaalit 2019 ja Paavo-data",
               tabPanel("Graafi", 
                        ...
                        sidebarLayout(
                          sidebarPanel(
                            fluidRow(
                              ...
                              radioButtons("xscale", NULL, choices=c("lineaarinen","log10"), inline = TRUE),
                              selectInput("muuttuja_y", "Y-akseli:", koodit, selected = "KOK_osuus"),
                              radioButtons("yscale", NULL, choices=c("lineaarinen","log10"), inline = TRUE),
                              selectInput("muuttuja_z", "Väri:", koodit, selected = "vaestotiheys")),
                            wellPanel("Osuudet ovat välillä 0-1 (1 vastaa 100%)"),
                            width = 4),
                          mainPanel(fluidRow(
               ...
               tabPanel("Kartta", 
                        ...
                        sidebarLayout(
                          sidebarPanel(
                            ...
                            mainPanel(
                                girafeOutput("postinumerokartta", height = "700px")
                                )
                          )
                        ),
