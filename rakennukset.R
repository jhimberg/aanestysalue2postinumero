...
kuntano2nimi <- function(kuntano, numero2nimi=readRDS(file="kuntano2kuntanimi.2018.rds")) plyr::mapvalues(kuntano, from=numero2nimi$kuntano, to=numero2nimi$kuntanimi, warn_missing = FALSE)
