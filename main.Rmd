...
# seuraavia kirjastoja tarvitaan. Lisäksi: plyr, DT, proj4, geosphere
library(dplyr)
library(stringr)
library(readr) 
library(tidyr)
...
Seuraavaksi lasketaan asuin/toimitilarakennusten määrä tilastointipostinumeroalueilla, äänestysalueilla ja näiden leikkauksissa. Liitetään alueiden nimitietoa ja keskimääräinen koordinaatti. Tätä käytetään poistamaan virheellisiä leikkauksia. 
...
Puolueen ääniosuuden ja korkeimman tuloluokan osuuden suhde alueella. 
